const ROUTES = {
  ...
  USER: {
    ...
    CART: "/customer/cart",
    PURCHASE: {
      DEFAULT: "/customer/purchase",
      PROCESSING: "/customer/purchase/processing",
      AWAITING_PAYMENT: "/customer/purchase/awaiting-payment",
      COMPLETED: "/customer/purchase/completed",
